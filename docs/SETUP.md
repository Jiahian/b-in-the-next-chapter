...
- **Someone can't sign in after tapping the link from Telegram** — not a setup problem, nothing to configure. Google blocks sign-in inside Telegram's built-in browser; the app already handles this automatically (see `docs/DECISIONS.md`).
